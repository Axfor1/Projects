...
-- first interview: Finding the names of the people who exit the courthouse 10 minutes after the theft.
...
--second interview: Finding the names of the people who withdrew money from the ATM on Fifer St on the day of the theft.
SELECT DISTINCT name FROM people JOIN bank_accounts ON people.id = bank_accounts.person_id
JOIN atm_transactions ON bank_accounts.account_number = atm_transactions.account_number WHERE day = "28" AND month = "7" AND year = "2020" AND transaction_type = "withdraw" AND atm_location = "Fifer Street";

-- third interview: Finding the names of the people who bought the first flight ticket for the day after the theft.
...
-- third interview: Finding the names of the people who had call for less than a minute on the day of the theft.
...
-- third interview: Finding the destination of the first flight ticket for the day after the theft.
...
-- third interview: Finding the name of the person whom the thief had call for less than a minute on the day of the theft.
